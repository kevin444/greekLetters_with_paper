...
#'
#' @description Function to obtain strings with Greek letters and mathematical symbols
...
#' @format A named list, see \code{names(greek)} for all Greek letters
#' and mathematical symbols names.
#'
#' @return Returns the desired Greek letter or mathematical symbol in string format.
#'
#' @note For users working with Rgui this function don't accept subscripts and just accept superscripts 1, 2 and 3. For more details run the commands:
#' superscriptSymbols
#' subscriptSymbols
#' greek
#'
